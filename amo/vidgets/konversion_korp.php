...
<div class="cell-wrapper text-center">
	<!-- Название виджета -->
	<div class="cell-wrapper__caption text-22">Конверсия</div>

	<!-- Главная цифра в виджете -->
	<div class="cell-wrapper__data">
		<div class="cell-wrapper__bottom <?=$exp < 25 ? 'red' : 'green'?>" title="500"><?=round($exp, 1)?>%</div>
	</div>
	<div class="semi-donut margin"
			 style="--percentage : <?=round($exp, 0)?>; --fill: #039BE5 ;">
	</div>
