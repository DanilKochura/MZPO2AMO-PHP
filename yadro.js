...
function func_check_simple_captcha() {
	...
	if (cn>cn_ctrl) {return true;} else {return false;}
...
var myhanda_4 = function() {
	...
	post_chk=false; if (II.$(this).closest('form').find('input[name="d[5][]"]').get(0)) post_chk=II.$(this).closest('form').find('input[name="d[5][]"]').get(0).checked;
...
if (1==2)
	if (window.location.hostname=='new.mirk.msk.ru')
	{
		...
		var myhanda_5 = function ()
		{
			...
			captcha_chk=true;
			post_chk=true;
			post_telp=false; if (params['post_telp']!='') post_telp=true;
...
//if (window.location.hostname=='mirk.msk.ru')
{
	...
	var myhanda_6 = function ()
	{
		...
		if(params[key_rv]) {} else {if(roistat_visit_decoded!='') {params[key_rv]=roistat_visit_decoded;}}
		...
		if (btn_form_id == '13107901_form_3' || btn_form_id == '514615_form_9' || btn_form_id  == '13107901_form_4' || btn_form_id == '25477507_form_5' ) {
		...
		} else if (btn_form_id == '16647101_form_1' || btn_form_id == '16647101_form_2') {
			...
			form_name = 'Обратный звонок';
		} else if (btn_form_id == '24955501_form_5' || btn_form_id == '24955501_form_6') {
		...
		}else if (btn_form_id == '8128707_form_4') {
